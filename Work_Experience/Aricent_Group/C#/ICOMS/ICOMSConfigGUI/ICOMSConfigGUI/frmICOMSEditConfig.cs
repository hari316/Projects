       ...
       /// <returns></returns>
        ...
        private void btnAddSite_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                isDirtyChanged = false;
                createNewSiteXMLNode(txtSiteID.Text.Trim(), txtSiteName.Text.Trim(), txtListenerAddress.Text.Trim(), txtlistenerPort.Text.Trim(), getValueForNodeFromComboBox(cmbNatFrmt4cFlag.SelectedIndex), getValueForNodeFromComboBox(cmbCusIdFlag.SelectedIndex),cmbDeviceIdFmt.SelectedItem.ToString());
        ...
        private void createNewSiteXMLNode(string strId, string strName, string strlAdd, string strlPrt, string strNatFmt4cFlg, string strCusFlg, string strDevIdFmt)
        {
