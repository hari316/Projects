...
public class SaxParser extends DefaultHandler  {
	...
	/**************************************** EMPLOYEE DETAILS FROM XML*********************************************/
	
	public List<EmpData> getXMLData() {
		
		String filePath ="D:/Java Coding/DynamicPage/EmployeeDetails.xml";
		...
		if(xmlFile.exists())
		{
			try {		
					...
					System.out.println("Employee List: "+_employees.values());	
					_result = new ArrayList<EmpData>(_employees.values());
					Collections.sort(_result, new Compare());
					System.out.println("Sorted Employee List :" + _result.toString());
